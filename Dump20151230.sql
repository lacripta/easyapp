...
BEGIN
insert into producto_categoria (producto_categoria_nombre) values (new.producto_categoria) on duplicate key update producto_categoria_nombre = producto_categoria;
insert into producto_grupo (producto_grupo_nombre, producto_categoria_nombre) values (new.producto_grupo, new.producto_categoria) on duplicate key update producto_grupo_categoria = producto_categoria, producto_grupo_nombre = producto_grupo;
END */;;
DELIMITER ;
...
-- Dump completed on 2015-12-30 10:26:07
