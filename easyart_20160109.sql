...
INSERT INTO `galeria` VALUES (4,'/easyart/img/carrusel/bgimage_1.jpg','vinilos','vinilos decorativos','vinilos decorativos','2016-01-06 21:01:35',1),(5,'/easyart/img/carrusel/bgimage_3.jpg','personalizados','vinilos personalizados','vinilos personalizados','2016-01-06 21:02:08',1),(6,'/easyart/img/carrusel/bgimage_4.jpg','decorativos','vinilos decorativos','vinilos decorativos','2016-01-06 21:02:45',1),(7,'/easyart/img/carrusel/bgimage_5.jpg','instalacion','servicio de instalacion','servicio de instalacion','2016-01-06 21:03:24',1),(8,'/easyart/img/carrusel/bgimage_6.jpg','infantil','decoracion infantil','decoracion infantil','2016-01-06 21:03:48',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=234 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gd_menu` VALUES (1,'Administracion','Gestión de Usuarios','http://localhost/easyapp/admin/usuario','Gestor de Usuarios',0,'Usuarios'),(2,'Administracion','Crear Usuario','http://localhost/easyapp/admin/usuario/add','Crear Usuario',1,'Usuarios'),(3,'Administracion','Editor de Menu','http://localhost/easyapp/admin/menu','Creador de Menu',4,'Menu'),(4,'Administracion','Gestión de Grupos','http://localhost/easyapp/admin/grupo','Gestor de Grupos',2,'Grupos'),(5,'Contenido','Gestión de Articulos','http://localhost/easyapp/admin/articulo','Gestor de Articulos',10,'Articulos'),(23,'Contenido','Carrusel','http://localhost/easyapp/admin/carrusel','Administrador de Imagenes del Carrusel',11,'Articulos'),(24,'Contenido','Productos','http://localhost/easyapp/admin/producto','Administrador de Productos',12,'Articulos');
...
INSERT INTO `gd_permisos_grupo` VALUES ('admin',1,1),('admin',2,1),('admin',3,1),('admin',4,1),('admin',5,1),('admin',6,1),('admin',7,1),('admin',8,1),('admin',9,1),('admin',10,1),('admin',11,1),('admin',12,1),('admin',13,1),('admin',14,1),('admin',15,1),('admin',16,1),('admin',17,1),('admin',18,1),('admin',19,1),('admin',20,1),('admin',21,1),('admin',22,1),('admin',23,1),('admin',24,1),('admin',25,1),('admin',26,1),('admin',27,1),('admin',28,1),('admin',29,1),('admin',30,1),('admin',31,1),('admin',32,1),('admin',33,1),('admin',219,1),('admin',220,1),('admin',221,1),('admin',222,1),('admin',223,1),('admin',224,1),('admin',225,1),('admin',226,1),('admin',227,1),('admin',228,1),('admin',229,1),('admin',230,1),('admin',231,1),('admin',232,1),('admin',233,1);
...
-- Dump completed on 2016-01-09  9:23:05
